      ...
      <div>
        {doctors.slice(0,3).map((item,index)=> (
          ...
          <div className='flex flex-col gap-2 justify-end'>
            ...
            <button   className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600 hover:text-white transiyion-all duration-300'>cancel Appointment</button>
          </div>
          </div>
        ))}
