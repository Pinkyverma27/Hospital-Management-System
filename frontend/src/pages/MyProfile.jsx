...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'richardjameshwap@gmail.com',
    phone: '+1 123 456 7890',
    address: {
      line1: "57th cross, Ricemond",
      ...
      <div className='mt-10'>
        {
          isEdit
            ...
            : <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transistion-all' onClick={() => setIsEdit(true)}>Edit</button>
        }
      </div>
    </div>
  )
