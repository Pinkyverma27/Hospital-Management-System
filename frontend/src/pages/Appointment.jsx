      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex item-center gap-2 text-sm mt-1 text-gray-600'>
            ...
            <button className='py-0.5 px-2 border text-5 rounded-full'>{docInfo.experience} </button>
          </div>
          {/*--------------Doc about--------------*/}
          <div>
          ...
          <p className='text-gray-500 font-medium mt-4'>
            Appointmet fee: <span className='text-gray-600 '>{currencySymbol} {docInfo.fees} </span> </p>
        </div>
      </div>
      {/*------booking slots-------*/}
